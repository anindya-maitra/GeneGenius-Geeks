...
#Cuda kernel code for parallel encoding
kernel="""
...
mod=compiler.SourceModule(kernel)       #compile the cuda kernel code
results=mod.get_function("encode")      #get the compiled code
