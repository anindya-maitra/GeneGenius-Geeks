import createDBN_custom as cd_c
from pgmpy.inference import VariableElimination

def pathway(fl,drugv,idict):
    cd_c.createDBN(fl,drugv)
    inference = VariableElimination(cd_c.model)
    ...
    r8 = inference.query(variables=['O8'], evidence=idict)
    r9 = inference.query(variables=['O9'], evidence=idict)
    l=[]
    if r1.values[0]==1.0:
        l.append(0)
    else:
